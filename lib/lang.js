export const lang = {
  en: {
    ...
    LAYOUT: {
      ...
      SHARE_TWITTER_BUTTON_TEXT: 'Tweet',
      PAY_BUTTON: 'Sponsor',
    ...
    HERO: {
      HOME: {
        ...
        RSS_BUTTON: 'Coming Soon' // TODO: Add RSS
      },
      NEWSLETTER: {
    ...
    CONTACT: {
      ...
      TWITTER_DM_DESCRIPTION: 'Or you can contact me via Twitter DM: ',
  ...
  ja: {
    ...
    LAYOUT: {
      ...
      SHARE_TWITTER_BUTTON_TEXT: 'ﾂｲｰﾖ',
      PAY_BUTTON: 'Coffee',
      NOTICE_BUTTON: 'Contact',
      COMMENT_TITLE: 'Comments'
    },
    ...
    CONTACT: {
      ...
      FORM_EMAIL_REQUIRED: '*You can fill in other valid contact methods',
      FAILED_MESSAGE:
        'Sorry, sending failed, please contact me directly on Twitter.'
    },
    FOOTER: {
      COPYRIGHT_START: 'This site is licensed under the ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0',
