var app = (function () {
  ...
  const V = { 'X-Client-Info': 'gotrue-js/1.22.12' },
    ...
    X = { name: 'sb', lifetime: 28800, domain: '', path: '/', sameSite: 'lax' }
  function Q(e, t) {
    var r, n, s
  ...
  class de {
    constructor({ url: e = '', headers: t = {}, cookieOptions: r, fetch: n }) {
      ;(this.url = e),
        (this.headers = t),
        (this.cookieOptions = Object.assign(Object.assign({}, X), r)),
        (this.fetch = ue(n))
    }
    ...
    _removeSession() {
      return fe(this, void 0, void 0, function* () {
        ;(this.currentSession = null),
          ...
          he() && (yield this.localStorage.removeItem(Y))
      })
    }
    ...
    constructor(e, t) {
      ...
      this.channel.on(r.state, {}, (e) => {
        ...
        ;(this.joinRef = this.channel.joinRef()),
          (this.state = Ye.syncState(this.state, e, t, r)),
        ...
        this.channel.on(r.diff, {}, (e) => {
          ...
          this.inPendingSyncState()
            ...
            : ((this.state = Ye.syncDiff(this.state, e, t, r)), n())
        })
    }
  ...
  class Xe {
    ...
    off(e, t) {
      this.bindings = this.bindings.filter(
        (r) => !(r.type === e && Xe.isEqual(r.eventFilter, t))
      )
    }
    canPush() {
      return this.socket.isConnected() && this.isJoined()
    ...
    return {
      ...
      p(e, t) {
        8 & t &&
          ...
          8 & t && O !== (O = Vt(e[4].created_at, 'en') + '') && b(_, O),
    ...
    return {
      c() {
        ;(r = p('div')),
          ...
          (k = p('div')),
          (T = p('button')),
          (T.innerHTML = '<p class="text-gray-400 h-5">Submit</p>'),
          ($ = g()),
          (E = p('p')),
          (E.textContent = '*Optional, your email or Telegram id.'),
          (O = g()),
          (S = p('div')),
          (x = p('div')),
          R && R.c(),
        ...
        y(o, 'name', 'name'),
          ...
          y(c, 'type', 'text'),
          (c.required = !0),
          y(c, 'placeholder', 'Your Email (Optional)*'),
          y(
            c,
            'class',
            'appearance-none block w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white'
          ...
          y(b, 'type', 'text'),
          (b.required = !0),
          y(b, 'placeholder', 'Comment content'),
          y(
            b,
            'class',
  ...
  function Qt(t) {
    ...
    return {
      c() {
        ;(r = p('h1')),
          (r.textContent = 'data-url is wrong'),
