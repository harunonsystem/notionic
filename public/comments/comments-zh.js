var app = (function () {
  ...
  function D(e, t, n, o) {
    const { fragment: a, on_mount: h, on_destroy: c, after_update: u } = e.$$
    a && a.m(t, n),
      o ||
        x(() => {
  ...
  function L(e, t) {
    ;-1 === e.$$.dirty[0] &&
      (k.push(e), S || ((S = !0), O.then(A)), e.$$.dirty.fill(0)),
  ...
  function M(t, r, i, o, a, c, u, l = [-1]) {
    ...
    if (
      ((p.ctx = i
        ? i(t, r.props || {}, (e, r, ...n) => {
            ...
            return (
              p.ctx &&
                a(p.ctx[e], (p.ctx[e] = s)) &&
                (!p.skip_bound && p.bound[e] && p.bound[e](s), m && L(t, e)),
              r
            )
          })
        : []),
      ...
      r.intro && I(t.$$.fragment),
        D(t, r.target, r.anchor, r.customElement),
        A()
    }
    w(d)
  }
  ...
  const H = { 'X-Client-Info': 'supabase-js/1.33.3' }
  ...
  const V = { 'X-Client-Info': 'gotrue-js/1.22.12' },
    X = 'supabase.auth.token',
    Y = { name: 'sb', lifetime: 28800, domain: '', path: '/', sameSite: 'lax' }
  function Q(e, t) {
    var r, n, s
        ...
        Q(
          ...
          (function (e) {
            ...
            const t =
              ...
              e.headers.host
            return !(
              ['localhost', '127.0.0.1'].indexOf(t) > -1 || t.endsWith('.local')
            )
          })(e)
        )
      ),
  ...
  const ue = (e) => {
    let t
    return (
      (t = e || ('undefined' == typeof fetch ? oe : fetch)), (...e) => t(...e)
    )
  }
  ...
  class de {
    constructor({ url: e = '', headers: t = {}, cookieOptions: r, fetch: n }) {
      ;(this.url = e),
        (this.headers = t),
        (this.cookieOptions = Object.assign(Object.assign({}, Y), r)),
        (this.fetch = ue(n))
    }
    ...
    signUpWithEmail(e, t, r = {}) {
      return le(this, void 0, void 0, function* () {
        try {
          ...
          let s = ''
          r.redirectTo &&
            (s = '?redirect_to=' + encodeURIComponent(r.redirectTo))
          const i = yield K(
              this.fetch,
              `${this.url}/signup${s}`,
              {
            ...
            o = Object.assign({}, i)
          return (
            o.expires_in && (o.expires_at = ae(i.expires_in)),
            { data: o, error: null }
          )
        } catch (e) {
      ...
      return le(this, void 0, void 0, function* () {
        try {
          const n = Object.assign({}, this.headers),
            ...
            i = Object.assign({}, s)
          return (
            i.expires_in && (i.expires_at = ae(s.expires_in)),
            { data: i, error: null }
          )
        } catch (e) {
          return { data: null, error: e }
      ...
      return le(this, void 0, void 0, function* () {
        try {
          const i = Object.assign({}, this.headers),
            ...
            h = Object.assign({}, a)
          return (
            h.expires_in && (h.expires_at = ae(a.expires_in)),
            { data: h, error: null }
          )
        } catch (e) {
          return { data: null, error: e }
      ...
      return le(this, void 0, void 0, function* () {
        try {
          const i = Object.assign({}, this.headers),
            ...
            a = Object.assign({}, o)
          return (
            a.expires_in && (a.expires_at = ae(o.expires_in)),
            { data: a, error: null }
          )
        } catch (e) {
          return { data: null, error: e }
      ...
      return le(this, void 0, void 0, function* () {
        try {
          const t = yield K(
            ...
            r = Object.assign({}, t)
          return (
            r.expires_in && (r.expires_at = ae(t.expires_in)),
            { data: r, error: null }
          )
        } catch (e) {
          return { data: null, error: e }
    ...
    createUser(e) {
      return le(this, void 0, void 0, function* () {
        try {
          const t = yield K(this.fetch, `${this.url}/admin/users`, e, {
            headers: this.headers
          })
    ...
    listUsers() {
      return le(this, void 0, void 0, function* () {
        try {
          return {
            data: (yield z(this.fetch, `${this.url}/admin/users`, {
              headers: this.headers
            })).users,
            error: null
          }
    ...
    getUserById(e) {
      return le(this, void 0, void 0, function* () {
        try {
          return {
            data: yield z(this.fetch, `${this.url}/admin/users/${e}`, {
              headers: this.headers
            }),
            error: null
          }
    ...
    getUser(e) {
      return le(this, void 0, void 0, function* () {
        try {
          const t = yield z(this.fetch, `${this.url}/user`, {
  ...
  class me extends class {
    ...
    signIn(
      ...
      return fe(this, void 0, void 0, function* () {
        try {
          ...
          if (e && r)
            return this._handleEmailSignIn(e, r, { redirectTo: o.redirectTo })
          if (t && !r) {
      ...
      return fe(this, void 0, void 0, function* () {
        try {
          ...
          const a = Math.round(Date.now() / 1e3) + parseInt(s),
            { user: h, error: c } = yield this.api.getUser(n)
          if (c) throw c
          const u = {
            provider_token: r,
            access_token: n,
    ...
    _recoverAndRefresh() {
      return fe(this, void 0, void 0, function* () {
        try {
          const e = he() && (yield this.localStorage.getItem(X))
          if (!e) return null
    ...
    _persistSession(e) {
      ...
      he() && this.localStorage.setItem(X, JSON.stringify(t))
    }
    _removeSession() {
      return fe(this, void 0, void 0, function* () {
        ;(this.currentSession = null),
          ...
          he() && (yield this.localStorage.removeItem(X))
      })
    }
        ...
        null === window ||
          ...
          window.addEventListener('storage', (e) => {
            ...
            if (e.key === X) {
              ...
              ;(
                null === (t = null == r ? void 0 : r.currentSession) ||
                void 0 === t
                  ? void 0
                  : t.access_token
              )
  ...
  class ve {
    constructor(e) {
      ...
      Object.assign(this, e),
        (t = e.fetch ? e.fetch : 'undefined' == typeof fetch ? oe : fetch),
        (this.fetch = (...e) => t(...e)),
  ...
  class _e extends ve {
    constructor(
      e,
      { headers: t = {}, schema: r, fetch: n, shouldThrowOnError: s } = {}
    ) {
  ...
  const ke = { 'X-Client-Info': 'postgrest-js/0.37.2' }
  class Te {
    constructor(
      e,
      { headers: t = {}, schema: r, fetch: n, throwOnError: s } = {}
    ) {
      ;(this.url = e),
        (this.headers = Object.assign(Object.assign({}, ke), t)),
        (this.schema = r),
        (this.fetch = n),
  ...
  if ('object' == typeof globalThis) Ce = globalThis
    ...
    try {
      ...
      if ((Ce || 'undefined' == typeof window || (Ce = window), !Ce))
  ...
  var Me = { w3cwebsocket: Be ? Le : null, version: De }
  const Fe = { 'X-Client-Info': 'realtime-js/1.6.2' }
  var He, Je, Ge, qe
  !(function (e) {
  ...
  class Ve {
    constructor(e, t = {}, r) {
      ;(this.topic = e),
        ...
        (this.joinPush = new We(this, Ge.join, this.params, this.timeout)),
        (this.rejoinTimer = new ze(
    ...
    push(e, t, r = this.timeout) {
      ...
      return (
        this.canPush() ? n.send() : (n.startTimeout(), this.pushBuffer.push(n)),
        n
      )
    }
    updateJoinPayload(e) {
    ...
    unsubscribe(e = this.timeout) {
      ...
      let t = () => {
        this.socket.log('channel', `leave ${this.topic}`),
          this.trigger(Ge.close, 'leave', this.joinRef())
      }
    ...
    trigger(e, t, r) {
      let { close: n, error: s, leave: i, join: o } = Ge
    ...
    constructor(e, t) {
      ...
      this.channel.on(r.state, {}, (e) => {
        ...
        ;(this.joinRef = this.channel.joinRef()),
          (this.state = Xe.syncState(this.state, e, t, r)),
          this.pendingDiffs.forEach((e) => {
            this.state = Xe.syncDiff(this.state, e, t, r)
          }),
          (this.pendingDiffs = []),
          n()
      }),
        this.channel.on(r.diff, {}, (e) => {
          ...
          this.inPendingSyncState()
            ...
            : ((this.state = Xe.syncDiff(this.state, e, t, r)), n())
        })
    }
  ...
  class Ye {
    ...
    off(e, t) {
      this.bindings = this.bindings.filter(
        (r) => !(r.type === e && Ye.isEqual(r.eventFilter, t))
      )
    }
    canPush() {
      return this.socket.isConnected() && this.isJoined()
    ...
    trigger(e, t, r) {
      const { close: n, error: s, leave: i, join: o } = Ge
      if (r && [n, s, i, o].indexOf(e) >= 0 && r !== this.joinRef()) return
      ...
      this.bindings
        .filter((r) => {
          var n, s
          return (
            (null == r ? void 0 : r.type) === e &&
            ('*' ===
              (null === (n = null == r ? void 0 : r.eventFilter) || void 0 === n
                ? void 0
                : n.event) ||
              (null === (s = null == r ? void 0 : r.eventFilter) || void 0 === s
                ? void 0
                : s.event) === (null == t ? void 0 : t.event))
          )
        })
        .map((e) => e.callback(a, r))
    }
  ...
  class tt {
    constructor(e, t) {
      ;(this.accessToken = null),
        ...
        (this.params = {}),
        (this.timeout = 1e4),
        (this.transport = Me.w3cwebsocket),
    ...
    channel(e, t = { isNewVersion: !1 }) {
      const { isNewVersion: r } = t,
        n = Ze(t, ['isNewVersion']),
        s = r
          ? new Ye(e, Object.assign({}, n), this)
          : new Ve(e, Object.assign({}, n), this)
      return (
        s instanceof Ye &&
          (s.presence.onJoin((e, t, r) => {
            s.trigger('presence', {
              event: 'JOIN',
              key: e,
              currentPresences: t,
      ...
      try {
        this.channels.forEach((t) => {
          e && t.updateJoinPayload({ user_token: e }),
            t.joinedOnce &&
              t.isJoined() &&
              t.push(Ge.access_token, { access_token: e })
        })
      } catch (e) {
    ...
    getPayloadRecords(e) {
      ...
      return (
        ('INSERT' !== e.type && 'UPDATE' !== e.type) ||
          (t.new = Ee(e.columns, e.record)),
        ('UPDATE' !== e.type && 'DELETE' !== e.type) ||
          (t.old = Ee(e.columns, e.old_record)),
        t
      )
    }
    on(e, t) {
  ...
  const st = { 'X-Client-Info': 'storage-js/0.0.0' }
    ...
    uploadOrUpdate(e, t, r, n) {
      return ft(this, void 0, void 0, function* () {
        try {
          ...
          if (c.ok) return { data: { Key: h }, error: null }
          return { data: null, error: yield c.json() }
        } catch (e) {
          return { data: null, error: e }
        }
      })
    ...
    constructor(e, { headers: t = {}, customFetch: r } = {}) {
      ;(this.url = e),
        ...
        (this.fetch = ((e) => {
          let t
          return (
            (t = e || ('undefined' == typeof fetch ? oe : fetch)),
            (...e) => t(...e)
          )
        })(r))
    }
    ...
    invoke(e, t) {
      return yt(this, void 0, void 0, function* () {
        try {
          ...
          if (i && 'true' === i)
            return { data: null, error: new Error(yield s.text()) }
          let o
  ...
  class kt {
    constructor(e, t, r) {
      ...
      ;(this.schema = s.schema),
        (this.multiTab = s.multiTab),
        (this.fetch = s.fetch),
        (this.headers = Object.assign(
          Object.assign({}, H),
          null == r ? void 0 : r.headers
        )),
        (this.shouldThrowOnError = s.shouldThrowOnError || !1),
              ...
              if ('supabase.auth.token' === e.key) {
                const s = JSON.parse(String(e.newValue)),
                  i =
                    null !==
                      (r =
                        null === (t = null == s ? void 0 : s.currentSession) ||
                        void 0 === t
                          ? void 0
                ...
                i
                  ? !o && i
                    ...
                    : o !== i &&
                      this._handleTokenChanged('TOKEN_REFRESHED', i, 'STORAGE')
  ...
  function Et(e, t) {
    var r = e[0],
      ...
      s = e[2],
      i = e[3]
    ;(r = St(r, n, s, i, t[0], 7, -680876936)),
      (i = St(i, r, n, s, t[1], 12, -389564586)),
      (s = St(s, i, r, n, t[2], 17, 606105819)),
      (n = St(n, s, i, r, t[3], 22, -1044525330)),
      (r = St(r, n, s, i, t[4], 7, -176418897)),
      (i = St(i, r, n, s, t[5], 12, 1200080426)),
      (s = St(s, i, r, n, t[6], 17, -1473231341)),
      (n = St(n, s, i, r, t[7], 22, -45705983)),
      (r = St(r, n, s, i, t[8], 7, 1770035416)),
      (i = St(i, r, n, s, t[9], 12, -1958414417)),
      (s = St(s, i, r, n, t[10], 17, -42063)),
      (n = St(n, s, i, r, t[11], 22, -1990404162)),
      (r = St(r, n, s, i, t[12], 7, 1804603682)),
      (i = St(i, r, n, s, t[13], 12, -40341101)),
      (s = St(s, i, r, n, t[14], 17, -1502002290)),
      (r = xt(
        r,
        (n = St(n, s, i, r, t[15], 22, 1236535329)),
        s,
        i,
        t[1],
        5,
      ...
      (i = xt(i, r, n, s, t[6], 9, -1069501632)),
      (s = xt(s, i, r, n, t[11], 14, 643717713)),
      (n = xt(n, s, i, r, t[0], 20, -373897302)),
      (r = xt(r, n, s, i, t[5], 5, -701558691)),
      (i = xt(i, r, n, s, t[10], 9, 38016083)),
      (s = xt(s, i, r, n, t[15], 14, -660478335)),
      (n = xt(n, s, i, r, t[4], 20, -405537848)),
      (r = xt(r, n, s, i, t[9], 5, 568446438)),
      (i = xt(i, r, n, s, t[14], 9, -1019803690)),
      (s = xt(s, i, r, n, t[3], 14, -187363961)),
      (n = xt(n, s, i, r, t[8], 20, 1163531501)),
      (r = xt(r, n, s, i, t[13], 5, -1444681467)),
      (i = xt(i, r, n, s, t[2], 9, -51403784)),
      (s = xt(s, i, r, n, t[7], 14, 1735328473)),
      (r = jt(
        r,
        (n = xt(n, s, i, r, t[12], 20, -1926607734)),
        s,
        i,
        t[5],
        4,
      ...
      (i = jt(i, r, n, s, t[8], 11, -2022574463)),
      (s = jt(s, i, r, n, t[11], 16, 1839030562)),
      (n = jt(n, s, i, r, t[14], 23, -35309556)),
      (r = jt(r, n, s, i, t[1], 4, -1530992060)),
      (i = jt(i, r, n, s, t[4], 11, 1272893353)),
      (s = jt(s, i, r, n, t[7], 16, -155497632)),
      (n = jt(n, s, i, r, t[10], 23, -1094730640)),
      (r = jt(r, n, s, i, t[13], 4, 681279174)),
      (i = jt(i, r, n, s, t[0], 11, -358537222)),
      (s = jt(s, i, r, n, t[3], 16, -722521979)),
      (n = jt(n, s, i, r, t[6], 23, 76029189)),
      (r = jt(r, n, s, i, t[9], 4, -640364487)),
      (i = jt(i, r, n, s, t[12], 11, -421815835)),
      (s = jt(s, i, r, n, t[15], 16, 530742520)),
      (r = Pt(
        r,
        (n = jt(n, s, i, r, t[2], 23, -995338651)),
        s,
        i,
        t[0],
        6,
      ...
      (i = Pt(i, r, n, s, t[7], 10, 1126891415)),
      (s = Pt(s, i, r, n, t[14], 15, -1416354905)),
      (n = Pt(n, s, i, r, t[5], 21, -57434055)),
      (r = Pt(r, n, s, i, t[12], 6, 1700485571)),
      (i = Pt(i, r, n, s, t[3], 10, -1894986606)),
      (s = Pt(s, i, r, n, t[10], 15, -1051523)),
      (n = Pt(n, s, i, r, t[1], 21, -2054922799)),
      (r = Pt(r, n, s, i, t[8], 6, 1873313359)),
      (i = Pt(i, r, n, s, t[15], 10, -30611744)),
      (s = Pt(s, i, r, n, t[6], 15, -1560198380)),
      (n = Pt(n, s, i, r, t[13], 21, 1309151649)),
      (r = Pt(r, n, s, i, t[4], 6, -145523070)),
      (i = Pt(i, r, n, s, t[11], 10, -1120210379)),
      (s = Pt(s, i, r, n, t[2], 15, 718787259)),
      (n = Pt(n, s, i, r, t[9], 21, -343485551)),
      (e[0] = It(r, e[0])),
      (e[1] = It(n, e[1])),
      (e[2] = It(s, e[2])),
      (e[3] = It(i, e[3]))
  ...
  var Nt = Object.defineProperty({ md5: Ct }, '__esModule', { value: !0 }),
    Dt =
      (te && te.__spreadArrays) ||
      function () {
  ...
  var Jt = function (e) {
      ...
      return (function (e) {
        return (
          '<svg width="300" height="300" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg"><rect id="bg" width="300" height="300" fill="rgb(' +
          Bt(e.background) +
          ')" /><path d="' +
          e.paths[0] +
          '" fill="rgb(' +
    ...
    Gt = Object.defineProperty(
      { invertHex: Mt, generatePath: Ht, generateFromString: Jt },
      '__esModule',
      { value: !0 }
    ).generateFromString
  function qt(e, t, r) {
    ...
    return {
      c() {
        ;(t = p('div')),
          ...
          ($ = g()),
          y(n, 'alt', 'avatar'),
          y(n, 'class', 'mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10'),
          c(
            n.src,
            (s = `data:image/svg+xml;utf8,${Gt(e[4].email || e[4].name)}`)
          ) || y(n, 'src', s),
          y(r, 'class', 'flex-shrink-0 mr-3'),
          y(v, 'class', 'text-xs text-gray-400'),
          y(k, 'class', 'text-sm'),
          y(
            o,
            'class',
      ...
      p(e, t) {
        8 & t &&
          ...
          y(n, 'src', s),
          8 & t && E !== (E = e[4].name + '') && b(h, E),
          8 & t && O !== (O = Vt(e[4].created_at, 'zh') + '') && b(_, O),
          8 & t && S !== (S = e[4].comment + '') && b(T, S)
      },
      d(e) {
        e && f(t)
      }
  ...
  function Wt(t) {
    let r,
      ...
      U = t[3],
      C = []
    for (let e = 0; e < U.length; e += 1) C[e] = Kt(qt(t, U, e))
    return {
      c() {
        ;(r = p('div')),
          (n = p('div')),
          ...
          (k = p('div')),
          (T = p('button')),
          (T.innerHTML = '<p class="text-gray-400 h-5">提交</p>'),
          ($ = g()),
          (E = p('p')),
          (E.textContent = '*如需回复, 请填写邮箱或其他有效联系方式.'),
          (O = g()),
          (S = p('div')),
          (x = p('div')),
          R && R.c(),
        ...
        y(o, 'name', 'name'),
          ...
          y(E, 'class', 'mb-2 text-gray-400 text-xs'),
          y(k, 'class', 'sm:col-span-2 flex justify-between items-center'),
          y(n, 'class', 'max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto'),
          y(x, 'class', 'mt-10 space-y-4'),
          y(S, 'class', 'mx-auto max-w-screen-md')
      },
      m(e, s) {
        d(e, r, s),
          l(r, n),
      ...
      p(e, [t]) {
        if (
          (2 & t && o.value !== e[1] && _(o, e[1]),
          4 & t && c.value !== e[2] && _(c, e[2]),
          16 & t && _(b, e[4]),
          e[0]
            ? R || ((R = zt()), R.c(), R.m(x, j))
            : R && (R.d(1), (R = null)),
          ...
          for (U = e[3], r = 0; r < U.length; r += 1) {
            const n = qt(e, U, r)
            C[r] ? C[r].p(n, t) : ((C[r] = Kt(n)), C[r].c(), C[r].m(x, null))
          }
  ...
  function Vt(e, t) {
    ...
    return 'zh' === t
      ? r.replace('年', ' 年 ').replace('月', ' 月 ').replace('日', ' 日')
      : r
  }
  function Xt(e, t, r) {
    let n
    ...
    const p = async () => {
      ...
      m = async () => {
        if (c && d) {
          const { data: e, error: t } = await h
            .from('comments')
            .insert({ postURL: i, name: c, email: l, comment: d, show: !0 })
    ...
    return (
      (e.$$set = (e) => {
        'hostURL' in e && r(6, (s = e.hostURL)),
          'postPath' in e && r(7, (i = e.postPath)),
          'supabaseUrl' in e && r(8, (o = e.supabaseUrl)),
          'anonKey' in e && r(9, (a = e.anonKey))
      }),
      [
        f,
        c,
  ...
  function Qt(t) {
    ...
    return {
      c() {
        ;(r = p('h1')),
          (r.textContent = 'data-url 配置错误'),
          y(r, 'class', 'text-6xl text-red-500 p-5')
      },
      m(e, t) {
        d(e, r, t)
      },
          ...
          const n =
            4 & t
              ? (function (e, t) {
                  ...
                  ((i = e[2]), 'object' == typeof i && null !== i ? i : {})
                ])
              : {}
          var i
          r.$set(n)
  ...
  function tr(e, t, r) {
    ...
    let { appUrl: i } = t,
      { supabaseUrl: o } = t,
      { anonKey: a } = t
    const h = { hostURL: s, postPath: n, supabaseUrl: o, anonKey: a }
    return (
      (e.$$set = (e) => {
        'appUrl' in e && r(0, (i = e.appUrl)),
          'supabaseUrl' in e && r(3, (o = e.supabaseUrl)),
          'anonKey' in e && r(4, (a = e.anonKey))
      }),
      [i, s, h, o, a]
    )
  }
  ...
  return new (class extends F {
    constructor(e) {
      super(), M(this, e, tr, er, o, { appUrl: 0, supabaseUrl: 3, anonKey: 4 })
    }
  })({ target: rr, props: { appUrl: nr, supabaseUrl: sr, anonKey: ir } })
})()
